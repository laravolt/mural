...
>
    ...
    @if(!$comments->isEmpty())
        <button class="btn btn-default submit mural-more" data-no-more-content="@lang('mural::mural.no_more_content')">@lang('mural::mural.load_more')</button>
    @else
        <a href="#" class="btn btn-block disabled button-empty" role="button">@lang('mural::mural.empty')</a>
    @endif
