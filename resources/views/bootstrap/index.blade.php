...
>
    ...
    @if(!$comments->isEmpty())
        <div class="row">
            <div class="col-md-12">
                <button class="btn btn-default btn-block submit mural-more" data-no-more-content="@lang('mural::mural.no_more_content')" style="opacity: 0.6; border: 0">@lang('mural::mural.load_more')</button>
            </div>
        </div>
    @else
